...
// ✅ Define proper type for your data
interface Post {
  _id: string;
  title: string;
  slug: {
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="h-72 bg-gradient-to-br from-gray-200 to-gray-100 relative overflow-hidden">
                ...
                {/* shine */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition bg-gradient-to-r from-transparent via-white/40 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] duration-1000"></div>
